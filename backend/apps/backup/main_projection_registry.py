...
class RowDisposition(StrEnum):
    ...
    OMIT_OPERATIONAL = "omit_operational"
...
# The live database UUID is generated by the target deployment after restore. A
# source value would make two databases claim the same authoritative identity.
OMITTED_OPERATIONAL_MODELS = frozenset({"backup.DeploymentDatabaseIdentity"})
    ...
    for model in apps.get_models(include_auto_created=True):
        ...
        if options.auto_created:
            ...
            if label not in MODELS:
                ...
                continue
            if label in OMITTED_OPERATIONAL_MODELS:
                disposition, predicate = RowDisposition.OMIT_OPERATIONAL, None
            else:
