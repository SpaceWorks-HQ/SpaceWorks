...
EXPORTED_MODEL_FIELDS = {
    ...
    "inventory.InventoryProduct": "id makerspace box category name description image_key tracking_mode total_quantity available_quantity reserved_quantity issued_quantity damaged_quantity lost_quantity needs_fix_quantity is_public public_self_checkout_enabled show_public_count public_availability_mode storage_location is_archived created_at updated_at search_vector",
