...
EXISTING_REPORT_DEFINITIONS = (
    ...
    ReportDefinition("event-attendance", "apps.operations.reports_events.build_event_attendance", ("event_id", "title", "starts_at", "status", "capacity", "registrations", "confirmed", "registered", "waitlisted", "cancelled", "attended", "attendance_rate_percent", "organizers"), ("events",), title="Event attendance", chart_hint="line"),
