...
EXPLICIT_AUTHORITY_FIELDS = {
    ...
    ("machines.MachineOperator", "machine"): "Dropped independent authority relation.",
    ("machines.MachineOperator", "user"): "Dropped identity receiving independent authority.",
    ("machines.MachineOperator", "access_level"): "Dropped operate/manage/full authority discriminator.",
